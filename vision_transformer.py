...
class SymptomHead(nn.Module):
    ...
    # NOTE: we deliberately return **raw logits**.
    #   * BCEWithLogitsLoss expects logits and is numerically more stable.
    #   * Down-stream code (evaluation) can convert to probabilities with
    #     torch.sigmoid when needed.
    def forward(self, x):
